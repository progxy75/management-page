import { p as e, b as t } from "./p-d7399561.js";
(() => {
  const t = import.meta.url,
    r = {};
  return "" !== t && (r.resourcesUrl = new URL(".", t).href), e(r);
})().then((e) =>
  t(
    [
      [
      ...
      ["p-fd444822", [[1, "presto-player-skeleton", { effect: [1] }]]],
      ["p-53d3dd5b", [[4, "presto-timestamp", { time: [1] }]]],
      [
        "p-fc6a912d",
        [[1, "presto-video-curtain-ui", { actionUrl: [1, "action-url"] }]],
      ],
      [
        "p-661c77b9",
        [
      ...
      [
        "p-39122522",
        [
          [1, "presto-action-bar-ui", { open: [4] }],
          [
            0,
            "presto-youtube-subscribe-button",
            { channel: [1], layout: [1], showCount: [4, "show-count"] },
          ],
        ],
      ],
      [
      ...
      [
        ...
        [
          ...
          [
            0,
            "presto-vimeo",
            { src: [1], poster: [1], player: [8], getRef: [1040] },
          ],
          [
            1,
