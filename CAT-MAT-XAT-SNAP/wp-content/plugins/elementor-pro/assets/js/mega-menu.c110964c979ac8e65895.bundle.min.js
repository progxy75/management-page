    ...
    9891: (e, t) => {
      ...
      t.default = class AnchorLinks {
        ...
        followMenuAnchor(e, t) {
          const n = e[0].hash,
            i = t.activeAnchorItem,
            o = t.anchorItem,
            s = e.hasClass(o) ? e : e.closest(`.${o}`);
          let r,
            l = -300;
          try {
          ...
          if (r.length) {
            ...
            elementorFrontend.waypoint(
              ...
              (t) => {
                "down" === t
                  ? (s.addClass(i), e.attr("aria-current", "location"))
                  : (s.removeClass(i), e.attr("aria-current", ""));
              },
      ...
      class MegaMenu extends elementorModules.frontend.handlers.NestedTabs {
        ...
        activateTab(e) {
          ...
          this.addAnimationToContentIfNeeded(e),
            ...
            l.addClass(n),
            l.css({ display: "var(--display)" }),
            l.removeAttr("display"),
            a.addClass(n),
            elementorFrontend.isEditMode() &&
              l.length &&
              this.activeContainerWidthListener(l),
            this.menuHeightController.reassignMenuHeight(l);
        }
        deactivateActiveTab(e) {
          const t = this.getSettings(),
            ...
            o = "." + n,
            s = this.elements.$tabDropdowns.filter(i),
            r = this.elements.$tabContents.filter(o),
        ...
        setTabDeactivationAttributes(e, t) {
          const n = this.isActiveTab(t),
            i = this.getSettings("ariaAttributes").titleStateAttribute;
          e.attr(`${i}`, "false"),
            t &&
              !n &&
        ...
        onTabClick(e) {
          ...
          const n = this.getSettings("selectors"),
            i = e?.currentTarget,
            o = i?.querySelector(n.tabDropdown),
            s = this.getTabIndex(o);
          this.changeActiveTab(s, !0);
        }
        bindEvents() {
        ...
        onMouseTitleEnter(e) {
          ...
          const t = this.getSettings(),
            ...
            i = t.selectors.tabDropdown,
            o = e?.currentTarget?.querySelector(i);
          if ("true" === o?.getAttribute(n)) return;
          const s = o?.getAttribute("data-tab-index");
          this.resetTabindexAttributes(), this.changeActiveTab(s, !0);
        }
        onClickToggleDropdownMenu(e) {
          ...
          const t = this.getSettings().classes.active,
            ...
            i = "true" === this.elements.$dropdownMenuToggle.attr(n);
          "boolean" != typeof e && (e = !i);
          const o = e ? "true" : "false";
          this.elements.$dropdownMenuToggle.attr(n, o),
        ...
        onClickOutsideDropdownMenu(e) {
          ...
          a
            ...
            : s || l || r || this.deactivateActiveTab();
        }
